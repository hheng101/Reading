...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [UIBarButtonItem itemWithTarget:self action:@selector(searchBook) image:@"search" highImage:nil];
