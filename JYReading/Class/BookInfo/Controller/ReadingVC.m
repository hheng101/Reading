...
- (void)viewDidLoad {
    ...
    self.pageManager.textRenderSize = CGSizeMake(SCREEN_WIDTH, SCREEN_HEIGHT-150);
...
-(NSMutableArray *)LabelsArray
{
    if(!_LabelsArray)
    {
        ...
        for(int i =0;i<3;i++)
        {
            UILabel *textLabel = [[UILabel alloc]initWithFrame:CGRectMake(SCREEN_WIDTH*i+10, 10, SCREEN_WIDTH-20, SCREEN_HEIGHT-84)];
